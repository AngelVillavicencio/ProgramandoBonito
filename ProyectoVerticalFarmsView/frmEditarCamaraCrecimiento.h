...
namespace ProyectoVerticalFarmsView {
	...
	public:
		...
		frmEditarCamaraCrecimiento(GestorCamaraCrecimiento^ objGestorCamaraCrecimiento, int indice)
		{
			InitializeComponent();
			//
			this->indice = indice;
			this->objGestorCamaraCrecimiento = objGestorCamaraCrecimiento;


			this->objCamaraCrecimiento = this->objGestorCamaraCrecimiento->buscaCamaraCrecimientoXindice(indice);
		}
	protected:
		/// <summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Text = L"frmEditarCamaraCrecimiento";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (ValidarId(this->textBox1->Text))
		{
			...
			this->objGestorCamaraCrecimiento->editarCamaraCrecimiento(indice, objCamaraCrecimientoNuevo);
			this->Close();
		}
		else
		{
...
private: System::Void frmEditarCamaraCrecimiento_Load(System::Object^ sender, System::EventArgs^ e) {
	//cod
	this->textBox1->Text = Convert::ToString(this->objCamaraCrecimiento->getId());
	this->textBox2->Text = Convert::ToString(this->objCamaraCrecimiento->getNumeroPiso());
	this->textBox3->Text = this->objCamaraCrecimiento->getTipoCultivo();
	this->textBox4->Text = this->objCamaraCrecimiento->getFaseCrecimiento();
	this->textBox5->Text = this->objCamaraCrecimiento->getEstadoEncendido();
	this->textBox6->Text = this->objCamaraCrecimiento->getComentario();
}
