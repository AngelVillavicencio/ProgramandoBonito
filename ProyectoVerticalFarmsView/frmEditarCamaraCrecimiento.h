...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(335, 522);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(133, 271);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(134, 209);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (ValidarId(this->textBox1->Text))
		{
			...
			this->objGestorEstacion->buscaEstacionXCodigo(this->codigoEstacion)->EditarCamaraXcodigo(this->codigoCamara,objCamaraCrecimientoNuevo);
			this->objGestorEstacion->editarCamaraCrecimiento(this->codigoCamara, objCamaraCrecimientoNuevo);
	...
	private: System::Void frmEditarCamaraCrecimiento_Load(System::Object^ sender, System::EventArgs^ e) {
		//cod
		this->textBox1->Text = Convert::ToString(this->objGestorEstacion->buscaEstacionXCodigo(this->codigoEstacion)->getCamaraXCodigo(this->codigoCamara)->getId());
		this->textBox2->Text = Convert::ToString(this->objGestorEstacion->buscaEstacionXCodigo(this->codigoEstacion)->getCamaraXCodigo(this->codigoCamara)->getNumeroPiso());
		this->textBox3->Text = this->objGestorEstacion->buscaEstacionXCodigo(this->codigoEstacion)->getCamaraXCodigo(this->codigoCamara)->getTipoCultivo();
		this->textBox4->Text = this->objGestorEstacion->buscaEstacionXCodigo(this->codigoEstacion)->getCamaraXCodigo(this->codigoCamara)->getFaseCrecimiento();
		this->textBox5->Text = this->objGestorEstacion->buscaEstacionXCodigo(this->codigoEstacion)->getCamaraXCodigo(this->codigoCamara)->getEstadoEncendido();
		this->textBox6->Text = this->objGestorEstacion->buscaEstacionXCodigo(this->codigoEstacion)->getCamaraXCodigo(this->codigoCamara)->getComentario();
	}
