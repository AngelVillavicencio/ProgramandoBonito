...
namespace ProyectoVerticalFarmsView {
	...
	/// </summary>
	public ref class frmCrearCamaraCrecimiento : public System::Windows::Forms::Form
	{
	public:
		frmCrearCamaraCrecimiento(void)
		{
			InitializeComponent();
			//
		...
		frmCrearCamaraCrecimiento(GestorCamaraCrecimiento^ objGestorCamaraCrecimiento)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmCrearCamaraCrecimiento::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmCrearCamaraCrecimiento::button1_Click);
			// 
			// textBox6
			// 
			...
			this->Name = L"frmCrearCamaraCrecimiento";
			this->Text = L"frmCrearCamaraCrecimiento";
			this->Load += gcnew System::EventHandler(this, &frmCrearCamaraCrecimiento::frmCrearCamaraCrecimiento_Load);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	if (ValidarId(this->textBox1->Text))
	{
		...
		this->objGestorCamaraCrecimiento->agregarCamaraCrecimiento(objCamaraCrecimientoNuevo);
		this->Close();		
	}
	else
	{
