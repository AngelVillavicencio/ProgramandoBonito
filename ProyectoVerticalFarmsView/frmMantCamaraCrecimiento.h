#pragma once
#include "frmCrearCamaraCrecimiento.h"
...
namespace ProyectoVerticalFarmsView {
	...
	/// </summary>
	public ref class frmMantCamaraCrecimiento : public System::Windows::Forms::Form
	{
	public:
		frmMantCamaraCrecimiento(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmMantCamaraCrecimiento::button1_Click);
			// 
			// textBox1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &frmMantCamaraCrecimiento::label1_Click);
			// 
			// panel2
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &frmMantCamaraCrecimiento::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &frmMantCamaraCrecimiento::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmMantCamaraCrecimiento::button2_Click);
			// 
			// dataGridView1
			// 
			...
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &frmMantCamaraCrecimiento::dataGridView1_CellContentClick);
			// 
			// codigo
			// 
			...
			this->Name = L"frmMantCamaraCrecimiento";
			this->Text = L"frmMantCamaraCrecimiento";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &frmMantCamaraCrecimiento::frmMantCamaraCrecimiento_FormClosing);
			this->Load += gcnew System::EventHandler(this, &frmMantCamaraCrecimiento::frmMantCamaraCrecimiento_Load);
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {//crear nuevo
	frmCrearCamaraCrecimiento^ VentanaCrearCamaraCrecimiento = gcnew frmCrearCamaraCrecimiento(this->objGestorCamaraCrecimiento);
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {//editar
	...
	else
	{
		...
		{
			frmEditarCamaraCrecimiento^ VentanaEditarCamaraCrecimiento = gcnew frmEditarCamaraCrecimiento(this->objGestorCamaraCrecimiento, indice);
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {//eliminar
	...
	else
	{
		...
		{
			this->objGestorCamaraCrecimiento->eliminarCamaraCrecimiento(indice);
			cargarGrilla();
			cargarVentana();
		}
	}
